...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => config('nmfs-uploads.upload_dir'),
            'upload_url' => config('nmfs-uploads.upload_url'),
            'input_stream' => 'php://input',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => config('nmfs-uploads.param_name'),
            ...
            'readfile_chunk_size' => config('nmfs-uploads.readfile_chunk_size'), // 2 MiB
...
//            'accept_file_types' => '/\.(gif|jpe?g|png)$/i',
            'accept_file_types' => config('nmfs-uploads.accept_file_types'), //pdf,mp4,flv,avi,mov,wmv,webm
            ...
            'max_file_size' => config('nmfs-uploads.max_file_size'),
            'min_file_size' => config('nmfs-uploads.min_file_size'),
            // The maximum number of files for the upload directory:
            'max_number_of_files' => config('nmfs-uploads.max_number_of_files'),
